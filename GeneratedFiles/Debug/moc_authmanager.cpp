...
QT_MOC_LITERAL(1, 12, 12), // "handle_error"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 10), // "error_dict"
QT_MOC_LITERAL(4, 37, 11), // "status_code"
QT_MOC_LITERAL(5, 49, 19), // "handle_auth_success"
QT_MOC_LITERAL(6, 69, 9) // "info_dict"

    },
    "AuthManager\0handle_error\0\0error_dict\0"
    "status_code\0handle_auth_success\0"
    "info_dict"
};
...
void AuthManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->handle_error((*reinterpret_cast< QJsonObject(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->handle_auth_success((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (AuthManager::*_t)(QJsonObject , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AuthManager::handle_error)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (AuthManager::*_t)(QJsonObject );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AuthManager::handle_auth_success)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void AuthManager::handle_error(QJsonObject _t1, int _t2)
{
...
// SIGNAL 1
void AuthManager::handle_auth_success(QJsonObject _t1)
{
